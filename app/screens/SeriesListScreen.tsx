...
export default function SeriesListScreen({ onBack, onTVPress }: SeriesListScreenProps) {
                        ...
                        {seriesList.map((series) => {
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        // 如果只有一个TV，直接跳转到TV详情
                                        if (series.tvInfos.length === 1 && onTVPress) {
                                            onTVPress(series.tvInfos[0]);
                                        }
                                        // 如果有多个TV，可以显示TV列表或第一个TV
                                        // 这里暂时显示第一个TV
                                        else if (series.tvInfos.length > 0 && onTVPress) {
                                            onTVPress(series.tvInfos[0]);
                                        }
                                    }}
                                >
