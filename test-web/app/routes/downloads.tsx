...
export default function Downloads() {
    ...
    useEffect(() => {
        ...
        if (autoRefresh) {
            const interval = setInterval(fetchProgress, 2000); // 每2秒刷新一次
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="flex justify-between items-center mb-8">
                    <div className="flex items-center gap-4">
                        <h1 className="text-3xl font-bold text-gray-900">下载进度</h1>
                        <a
                            href="/search"
                            ...
                            return (
                                ...
                                >
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center gap-4 text-sm text-gray-600">
                                                <span>
                                                    状态:{" "}
                                                    <span
                                                        className={`font-medium ${progress.downloading
                                                            ? "text-blue-600"
                                                            : "text-gray-500"
                                                            }`}
                                                    >
                                                        {progress.downloading ? "下载中" : "已暂停"}
                                                    </span>
                                                </span>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                        <div>
                                            <span className="text-gray-500">已下载:</span>
